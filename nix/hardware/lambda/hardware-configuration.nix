...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/1df8df5e-d042-48ac-949d-2f6f220d2ea8";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/AD3A-D266";
      fsType = "vfat";
  ...
  # networking.interfaces.enp141s0u6u3c2.useDHCP = lib.mkDefault true;
