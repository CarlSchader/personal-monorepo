...
let
  ...
  carls-keys = [
    ...
    "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAINd9//pPEy5d3mhGpSUnYgqqSqkhYqiXyWVumS0yqImsAAAABHNzaDo= personal key" # yubikey personal
  ];
  connors-keys = [ 
